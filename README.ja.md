...
- 🧩 **Agent Skills 同梱** — `gh skill` でインストールでき、Claude Code などのエージェントが tegakari の設定や出力を賢く扱えるようになる。詳細は [`skills/README.md`](skills/README.md)
...
- 出力フォーマット（JSONL / Markdown）の選好を保存し、次回も維持
