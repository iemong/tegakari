...
test("Options page: prefix rules import / export — Export button is disabled when there are no rules", async ({
  context,
  extensionId,
}) => {
...
test("Options page: prefix rules import / export — Export downloads a JSON file containing the current rules", async ({
  context,
  extensionId,
  seedPrefixRules,
}) => {
...
test("Options page: prefix rules import / export — Import merges JSON rules into existing storage (upsert + append)", async ({
  context,
  extensionId,
  seedPrefixRules,
  readPrefixRules,
...
test("Options page: prefix rules import / export — Import surfaces an error banner for invalid JSON", async ({
  context,
  extensionId,
  readPrefixRules,
}) => {
...
test("Options page: prefix rules import / export — Import normalizes full-URL patterns on the way in", async ({
  context,
  extensionId,
  readPrefixRules,
}) => {
...
test("Options page: prefix rules import / export — Round trip: export → wipe → import restores the same rules", async ({
  context,
  extensionId,
  seedPrefixRules,
  readPrefixRules,
